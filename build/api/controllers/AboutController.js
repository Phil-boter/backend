...
var AboutService_1 = __importDefault(require("../services/AboutService"));
var AboutController = /** @class */ (function () {
    function AboutController() {
    }
    AboutController.getAbout = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, AboutService_1.default.aboutInformation()];
                    case 1:
                        data = _a.sent();
